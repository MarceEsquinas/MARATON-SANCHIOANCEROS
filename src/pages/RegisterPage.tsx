    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black text-slate-800 tracking-tight">Empieza tu viaje</h1>
          <p className="text-slate-500 mt-2">Crea tu cuenta y planifica tu éxito.</p>
        </div>
